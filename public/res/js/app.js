...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Auto-fetch SVGs and inject into elements from '[data-svg-src]'
  document.querySelectorAll("[data-svg-src]").forEach(async el => {
  ...
  loginBtn.addEventListener('click', toggleClass);
  signupBtn.addEventListener('click', toggleClass);



  // --fix-underlay shift on scrollbar reappearence--
