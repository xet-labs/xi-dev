...
<?php if (Auth::check()) { ?>
    ...
    <section class="signuplogin-wrap">
    <!-- logOut btn -->
    <form method="post" action="<?= route('user.logout'); ?>">
        <?php include(Loc::file('PRTL','csrf')); ?>
        <?php include(Loc::file('PRTL','currentUrl')); ?>
        <button type="submit" name="submit_logout" aria-label="Log Out" class="icon" tabindex="0" title="Logout">
...
<?php }else{ ?>
    ...
    <input type="radio" name="signuplogin-btn-grp" id="id-login-btn" class="underlay-show-btn">
    <input type="radio" name="signuplogin-btn-grp" id="id-signup-btn" class="underlay-show-btn">
    <input type="radio" name="signuplogin-btn-grp" id="id-signuplogin-close-btn" class="underlay-hide-btn">
    
    <label for="id-login-btn" aria-label="Log In" class="icon" tabindex="0" title="Log in">
            ...
            <div class="login-wrap">
                ...
                <form class="signuplogin-form" method="post" action="<?= route('user.login'); ?>">
                    ...
                    <div>
                        ...
                        <div class="label-wrap tosignuplogin">
                            <sapn>Don't have an account? <label for="id-signup-btn" aria-label="Sign Up">Sign up</label></sapn>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="signup-wrap">
                ...
                <form class="signuplogin-form" method="post" action="<?= route('user.signup'); ?>">
                    ...
                    <div class="field">
                        ...
                        <input type="text" name="signup_name" id="user-name" autocomplete="username" aria-label="Name" required placeholder="full name">
                    </div>

                    <div class="field">
                        <div class="label-wrap"><sapn>Email</sapn></div>

                        <input type="email" name="signup_email" id="signup-email" autocomplete="new-email" aria-label="Email Address" required placeholder="email@gmail.com">
                    </div>
                    ...
                    <div class="field">
                        ...
                        <input type="password" name="signup_pass" id="signup-pass" autocomplete="new-username" aria-label="Email Password" required placeholder="password">
                    </div>

                    <div>
                        <button type="submit" name="submit_signup" class="submit-signup-btn" tabindex="0" aria-label="Submit Signup">Sign Up</button>
                        <div class="label-wrap tosignuplogin">
                            <sapn>Already have an account? <label for="id-login-btn" aria-label="Log In">Log in</label></sapn>
                        </div>
                    </div>
                </form>
            </div>
